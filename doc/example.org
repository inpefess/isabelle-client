...
[IsabelleResponse(response_type=<IsabelleResponseType.OK: 'OK'>,
                  response_body={'isabelle_id': '4b875a4c83b0',
                                 'isabelle_name': 'Isabelle2025'},
...
[IsabelleResponse(response_type=<IsabelleResponseType.OK: 'OK'>,
                  ...
                  response_length=None),
 IsabelleResponse(response_type=<IsabelleResponseType.OK: 'OK'>,
                  response_body={'task': 'f5e044d3-8f3d-4e1f-bdb9-928fcb3039a8'},
                  response_length=None),
 IsabelleResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>,
                  response_body={'kind': 'writeln',
                                 'message': 'theory Draft.Example 71%',
                                 'percentage': 71,
                                 'session': '',
                                 'task': 'f5e044d3-8f3d-4e1f-bdb9-928fcb3039a8',
                                 'theory': 'Draft.Example'},
                  response_length=161),
 IsabelleResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>,
                  response_body={'kind': 'writeln',
                                 'message': 'theory Draft.Example 99%',
                                 'percentage': 99,
                                 'session': '',
                                 'task': 'f5e044d3-8f3d-4e1f-bdb9-928fcb3039a8',
                                 'theory': 'Draft.Example'},
 ...
 IsabelleResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>,
                  response_body={'kind': 'writeln',
                                 'message': 'theory Draft.Example 100%',
                                 'percentage': 100,
                                 'session': '',
                                 'task': 'f5e044d3-8f3d-4e1f-bdb9-928fcb3039a8',
                                 'theory': 'Draft.Example'},
 ...
 IsabelleResponse(response_type=<IsabelleResponseType.FINISHED: 'FINISHED'>,
                  response_body={'errors': [],
                                 'nodes': [{'exports': [],
                                            'messages': [{'kind': 'writeln',
                                                          'message': 'theorem '
                                                                     '\\<forall>x. '
                                                                     '\\<exists>y. '
                                                                     'x = y',
                                                          'pos': {'end_offset': 61,
                                                                  'file': '../examples/Example.thy',
                                                                  'line': 5,
                                                                  'offset': 59}}],
                                            'node_name': '../examples/Example.thy',
