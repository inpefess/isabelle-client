...
#+RESULTS:
: [TaskOK(response_type=<IsabelleResponseType.OK: 'OK'>, response_body=Task(task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=None), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Pure/Pure', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=117), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Misc/Tools', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=118), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session HOL/HOL (main)', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=122), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Doc/Main (doc)', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=122), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Pure/Pure', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=117), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Misc/Tools', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=118), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session HOL/HOL (main)', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=122), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Session Doc/Main (doc)', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=122), NotificationResponse(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=MessageNotification(kind='writeln', message='Starting session Main ...', pos=None, task='5424521f-712c-46ef-93cb-15518c9bbc4e'), response_length=126), SessionStartRegularResponse(response_type=<IsabelleResponseType.FINISHED: 'FINISHED'>, response_body=SessionStartRegularResult(task='5424521f-712c-46ef-93cb-15518c9bbc4e', session_id='9b437ba2-b25e-4d76-882d-6a2217e09f6d', tmp_dir='/tmp/isabelle-boris/server_session10038091364255846623'), response_length=176)]
...
#+RESULTS:
: [TaskOK(response_type=<IsabelleResponseType.OK: 'OK'>, response_body=Task(task='32980482-300a-4a5d-99da-2d3e7597445c'), response_length=None), TaskOK(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=Task(task='32980482-300a-4a5d-99da-2d3e7597445c'), response_length=161), TaskOK(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=Task(task='32980482-300a-4a5d-99da-2d3e7597445c'), response_length=161), TaskOK(response_type=<IsabelleResponseType.NOTE: 'NOTE'>, response_body=Task(task='32980482-300a-4a5d-99da-2d3e7597445c'), response_length=163), UseTheoriesResponse(response_type=<IsabelleResponseType.FINISHED: 'FINISHED'>, response_body=UseTheoriesResults(ok=True, errors=[], nodes=[NodeResult(node_name='../examples/Example.thy', theory_name='Draft.Example', status=NodeStatus(ok=True, total=7, unprocessed=0, running=0, warned=0, failed=0, finished=7, canceled=False, consolidated=True, percentage=100), messages=[Message(kind='writeln', message='theorem \\<forall>x. \\<exists>y. x = y', pos=Position(line=5, offset=59, end_offset=61, file='../examples/Example.thy', id=None))], exports=[])]), response_length=482)]
